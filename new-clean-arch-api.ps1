...
### DTOs y contratos
- **No exponer entidades de dominio** directamente en respuestas HTTP. Usar DTOs (`Application/Models`).
...
- Publicar la spec en `/swagger` (desarrollo) y opcionalmente en producção con auth.
